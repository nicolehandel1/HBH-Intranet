...
<div id="evcal_4" class="postbox evcal_admin_meta curve" style='overflow: hidden;padding:20px'>		
	...
	<div class='evo_extend_page inside'>		
		...
		<div class='evo_ft_compare'>
			...
			<div class='tac'>
				<p><?php _e('Extend the features of EventON Lite with EventON!','eventon');?></p>
				<h3><?php _e('Compare Features of EventON vs EventON Lite','eventon');?></h3>
			</div>
			...
			foreach( array(
			array(__('Support various event repeat methods','eventon'),
				'same',
			...
			array('Schedule View','same'),
			array('Basic Events lists','same'),
			array('Various Event Tiles','same'),
			array('Single Event Box Anywhere','same'),
			...
			array('Ability to set default eventtop style','Ability to set default eventtop style'),
			...
			array('Supports 5 default categories','Supports 5 default categories', 'Categorization'),
