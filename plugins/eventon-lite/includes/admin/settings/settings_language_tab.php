...
class evo_settings_lang{
	...
	function get_content(){
		...
		<form method="post" action=""><?php settings_fields('evcal_field_group'); 
			...
			<p style='padding:0'><input type="submit" class="evo_admin_btn btn_prime" value="<?php _e('Save Changes','eventon') ?>" style='margin-top:15px'/>  <a href='https://docs.myeventon.com/documentations/how-to-translate-calendar-front-end/' target='_blank'><?php _e('Guide: How to use EventON Language Settings','eventon');?></a></p>
