...
class EVO_Welcome_Page {
	...
	public function admin_menus() {
		$welcome_page_title = __( 'Welcome to EventON Lite', 'eventon' );
		...
		add_dashboard_page(
			__( 'Getting started with EventON Lite Calendar', 'eventon' ),
			__( 'Getting started with EventON Lite Calendar', 'eventon' ),
			'manage_options',
			'evo-getting-started',
		...
		// Changelog Page
		add_dashboard_page(
			__( 'EventON Lite Changelog', 'eventon' ),
			__( 'EventON Lite Changelog', 'eventon' ),
			'manage_options',
			'evo-changelog',
	...
	public function changelog_screen() {
		...
		<div class="wrap about-wrap">
			<h1><?php _e( 'EventON Lite Calendar Changelog', 'eventon' ); ?></h1>
			<div class="about-text"><?php printf( __( 'Thank you for updating to the latest version! EventON Lite Calendar %s is a stylish minimal calendar that will help you stay on top!', 'eventon' ), $display_version ); ?></div>
			...
			<div class="return-to-dashboard">
				<a href="<?php echo esc_url( admin_url('admin.php?page=eventon' ) ); ?>"><?php _e( 'Go to EventON Lite Settings', 'eventon' ); ?></a>
			</div>
		</div>
		<?php
	}
		...
		public function about_screen() {
			...
			<div class='evo_welcome_page'>	
				<div class="wrap about-wrap eventon-welcome-box">
					...
					<div class="return-to-dashboard">
						<a class='evo_wel_btn' href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'eventon' ), 'admin.php' ) ) ); ?>"><?php _e( 'Go to EventON Lite Settings', 'eventon' ); ?></a>
					</div>
					<div class='evowel_info1'>
						<p class='h3'><?php
							if(!empty($_GET['evo-updated']))
								$message = __( 'Thank you for updating EventON Lite to ver ', 'eventon' );
							else
								$message = __( 'Thank you for downloading EventON Lite ver ', 'eventon' );
						...
						<p class='h4'><?php 
							if(!empty($_GET['evo-updated']))
								...
								printf( __( 'We hope you will enjoy eventON Lite - Event calendar plugin for WordPress!','eventon'));
						?></p>						
					</div>
	...
	public function getting_started_screen(){
		...
		<div class="wrap about-wrap">
			<h1><?php printf( __( 'Welcome to EventON Lite %s', 'eventon' ), $display_version ); ?></h1>
			<div class="about-text"><?php printf( __( 'Thank you for updating to the latest version! EventON Lite Calendar %s is a stylish minimal calendar that will help you stay on top!', 'eventon' ), $display_version ); ?></div>
			<div class="evo-badge"><?php printf( __( 'Version %s', 'eventon' ), $display_version ); ?></div>

			<?php $this->tabs(); ?>

			<p class="about-description"><?php _e( 'Use these tips to get started with EventON Lite Calendar.', 'eventon' ); ?></p>
